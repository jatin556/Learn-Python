...
class Util:
    def __init__(self):
        self.list_customer_calldetail_objects = None
    def parse_customer(self,list_of_customers,list_of_calls):
        self.list_customer_calldetail_objects = []
        for cust in list_of_customers:
            cust.list_of_calls = []
            for call in list_of_calls:
                if cust.phone_no == call.phone_no:
                    cust.list_of_calls.append(call)
            self.list_customer_calldetail_objects.append()
